...
<!-- Latest: 2026-05-01 — labeled current-surface calibration panel (exp #301) + synthetic invocation (exp #302). halluc-ungrounded recall ≈ 3.5% (1/13 hallucinations across natural+synthetic; silent pass on 5/5 Veyr Dominion injections). adherence-events 100%/100% on natural and synthetic — READY for obligation-aware checks. Next concrete checker work: halluc-ungrounded prompt revision targeting title+surname / named-institution / lore-event entities, regression-tested on the same labeled panel. See decisions.md. -->
