...
- Corpus structure recreation is active: v3 personal-stake planning survived ch1+ch2 sequence drafting with clean sequence audit and no semantic lows. Next test fixed-v3 writer-context capsules or short-scene expansion.
