...
- Semantic-gate diagnostics shipped: writer expansion, Diagnostics landing
  page, default-off planning beat-cap seam, cohort aggregation, baseline/matrix viewers, candidate ranking, load-bearing discounts, action/proposal evidence, drift witnesses.
