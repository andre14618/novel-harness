...
- **Genre-specific plotline lane is active (L109).** Adult guild/mercenary mission progression fantasy is on the production path; story-shape proof drafted 10/10 chapters, and bounded ch2 repair cleared scene lows to 0/18. See `docs/sessions/2026-05-14-rillgate-story-shape-evidence.md`.
...
- **Authoring-bible production validation (2026-05-15).** Full-source selector audit on Rillgate with `rillgate-contrast-v1` found 49/49 slices, one exact stable-prefix hash, 0 errors, and 2 high-rule-count warnings; bounded ch1-3 A/B completed cleanly with authoring-bible at 9,474/9,300 words, Plan-Assist 0, checker readiness 0, voice differentiation 9/9 pass, and selected-rule review 360/360 pass. Next larger candidate draft can use `drafting-brief-authoring-bible-v1` as a default-off production arm with normal settle loops. See `docs/sessions/2026-05-15-authoring-bible-production-validation.md`.
