...
- Corpus structure recreation is active: sequence IDs survived ch1+ch2 drafting; `causal-motivation-v3` cleared a ch1 motivation low with clean plan fit. Next broaden sequence or pair fixed v3 planning with character-context writer capsules.
