...
issues. First-class anchor cohort `litrpg-scene-anchor-cohort-1778475936` worsened to 20/45 lows, WFACT 2/9, and 4005/2700 = 1.48x despite one observed scene contract; shape telemetry now separates anchor-only from dramatic contract coverage; do not flip defaults. See L103-L106.
