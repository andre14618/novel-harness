...
- For fantasy seeds, the active default remains the Salvatore voice LoRA route. Track A validation of base DeepSeek V4 Flash in the same pack returned NO-SHIP (exp #265, novel `novel-1777573197451`) due to full-novel read-through defects; see `docs/decisions.md` 2026-04-30.
