...
- [bun-test-module-mock-hygiene](bun-test-module-mock-hygiene.md) — `bun:test` `mock.module()` calls are process-global; partial mocks leak missing exports and stubbed helper behavior into sibling files.
