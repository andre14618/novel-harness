...
const SCENARIOS: Scenario[] = [
  ...
  // ── 10 dark fantasy scenarios with VAR_WARNING_2 ──────────────────────────
  {
    id: "necromancer_failed_ritual",
    setting: "A stone ossuary beneath a ruined chapel, midnight",
    characters: ["Veska", "Thane"],
    facts: [
      { chapter: 1, category: "death", fact: "The corpse of Archdeacon Pell was consumed entirely by the failed binding — nothing remains" },
      { chapter: 2, category: "object", fact: "Veska's obsidian focus-stone cracked down the center during the failed ritual and is now inert" },
      { chapter: 3, category: "event", fact: "Thane sealed the lower crypt with a blood ward to contain the residual energy" },
      { chapter: 4, category: "knowledge", fact: "Thane does not yet know that Veska used his blood — taken while he slept — to power the original ritual" },
      { chapter: 5, category: "rule", fact: "The ossuary's dead-silence ward suppresses all spoken incantations — spells must be cast through somatic gestures only" },
    ],
    states: [
      { character: "Veska", location: "the upper ossuary chamber", emotional_state: "shaken, guilt-ridden over Pell's destruction", knows: ["Pell is gone", "the focus-stone is broken", "she used Thane's blood without consent"] },
      { character: "Thane", location: "the upper ossuary chamber", emotional_state: "wary and exhausted from maintaining the blood ward", knows: ["the ritual failed", "the lower crypt is sealed", "the focus-stone is cracked"] },
    ],
    premise: "Veska and Thane stand in the cold upper chamber surveying the aftermath; Thane checks the integrity of his blood ward on the lower door while Veska gathers the shards of her focus-stone.",
    blockerInjection: "Have ARCHDEACON PELL step out from the lower crypt and demand to know what happened to his chapel (Pell was entirely consumed by the failed binding per ch1).",
    warningInjection: "Have Thane say they should 'walk back to the village before dawn' when the ossuary is established as being directly beneath the chapel they are already in.",
    warningInjection2: "Have Veska act composed, clinical, and emotionally detached — calmly analyzing the ritual's failure as an academic exercise — when she is established as shaken and guilt-ridden over Pell's destruction.",
    nitInjection: "Describe Veska's focus-stone as 'obsidian' early in the scene and as 'onyx' a few sentences later.",
    trapPhrase: "the dead in their niches watched with the patience that only the dead have earned",
  },
  {
    id: "blood_oath_dying_knight",
    setting: "A rain-soaked battlefield clearing, just after dusk",
    characters: ["Ser Caden", "Morreth"],
    facts: [
      { chapter: 2, category: "wound", fact: "Ser Caden took a lance through his side and is bleeding out — the wound is mortal without magical intervention" },
      { chapter: 3, category: "death", fact: "Caden's squire, Tam, was killed in the charge and his body lies somewhere on the field" },
      { chapter: 3, category: "object", fact: "Caden's shield was split in half by a war-hammer blow and is useless" },
      { chapter: 4, category: "rule", fact: "Blood oaths in this world require the oath-giver's freely shed blood — coerced or unconscious blood invalidates the pact" },
      { chapter: 5, category: "knowledge", fact: "Caden does not know that Morreth is a blood-witch, not a battlefield healer" },
    ],
    states: [
      { character: "Ser Caden", location: "the clearing, propped against a fallen tree", emotional_state: "dying, desperate, grasping at hope", knows: ["he is mortally wounded", "Tam is dead", "a healer has appeared"] },
      { character: "Morreth", location: "the clearing, kneeling beside Caden", emotional_state: "calculating, patient — she needs a willing oath", knows: ["Caden is dying", "she needs his freely given blood for the oath", "Tam is dead"] },
    ],
    premise: "Morreth kneels beside the dying knight in the rain and offers to close his wound; Caden, half-delirious, asks what she wants in return, and she tells him only a drop of his blood freely given.",
    blockerInjection: "Have TAM, Caden's squire, stumble out of the rain carrying a water skin and kneel beside his master (Tam was killed in the charge per ch3).",
    warningInjection: "Describe the scene opening just after dusk in rain, then within a few sentences describe 'the noon sun burning through the clouds overhead' with no time-skip.",
    warningInjection2: "Have Morreth act openly compassionate and selfless, reassuring Caden she wants nothing and is helping purely out of kindness — when she is established as calculating and patient, needing his blood for a specific purpose.",
    nitInjection: "Describe Caden's lance wound as being 'through his left side' early on and 'through his right side' a few sentences later.",
    trapPhrase: "the rain kissed his wounds the way a mother kisses a fever — without any power to cure",
  },
  {
    id: "lich_court_petitioner",
    setting: "The Throne of Whispers, a vast underground hall lit by corpse-light, timeless",
    characters: ["The Undying King", "Petitioner Soraya"],
    facts: [
      { chapter: 1, category: "rule", fact: "No living person may speak the Undying King's true name — doing so causes immediate petrification" },
      { chapter: 2, category: "death", fact: "Soraya's brother Kevan was executed by the Undying King's Pale Guard last chapter for smuggling iron past the wards" },
      { chapter: 3, category: "object", fact: "Soraya surrendered her iron dagger at the bone gate — no iron is permitted in the throne hall" },
      { chapter: 4, category: "knowledge", fact: "Soraya does not yet know that the Undying King kept Kevan's soul in a phylactery rather than releasing it" },
    ],
    states: [
      { character: "The Undying King", location: "the Throne of Whispers", emotional_state: "ancient, amused by mortal grief", knows: ["Kevan's soul is in the phylactery", "Soraya surrendered her dagger", "his true name is a killing word"] },
      { character: "Petitioner Soraya", location: "kneeling before the throne", emotional_state: "terrified, grief-stricken, barely holding herself together", knows: ["her brother is dead", "she gave up her dagger", "the true name must never be spoken"] },
    ],
    premise: "Soraya kneels on the cold stone before the Throne of Whispers and petitions the Undying King for her brother's remains; the Undying King listens from behind his mask of bone.",
    blockerInjection: "Have Soraya draw her iron dagger from her belt and lay it on the steps as an offering (she surrendered it at the bone gate per ch3).",
    warningInjection: "Have Soraya reference 'the weeks since Kevan's death' when his execution happened last chapter, implying only days have passed in story time.",
    warningInjection2: "Have Soraya address the Undying King with bold confidence, making demands and threatening consequences — when she is established as terrified and barely holding herself together.",
    nitInjection: "Describe the Undying King's mask as 'bone' early on and as 'tarnished silver' a few sentences later.",
    trapPhrase: "the corpse-light made the living look dead and the dead look patient",
  },
  {
    id: "cursed_artifact_handoff",
    setting: "A candlelit vault beneath a merchant's counting house, late evening",
    characters: ["Eris", "Collector Veld"],
    facts: [
      { chapter: 2, category: "object", fact: "The Weeping Crown causes anyone who touches it bare-handed to hear the voices of the dead for three days" },
      { chapter: 3, category: "event", fact: "Eris wrapped the Crown in lead-lined cloth to suppress its influence during transport" },
      { chapter: 4, category: "object", fact: "Veld's warding gloves — the only pair in the city rated to handle cursed artifacts — were destroyed when he handled the Spite Mirror last week" },
      { chapter: 4, category: "knowledge", fact: "Eris does not know that Veld's warding gloves are destroyed — she expects him to handle the Crown safely" },
      { chapter: 5, category: "event", fact: "The counting house's upper floor was gutted by fire two days ago — only the vault below survived" },
    ],
    states: [
      { character: "Eris", location: "the vault", emotional_state: "cautious, eager to be rid of the Crown", knows: ["the Crown must not be touched bare-handed", "the Crown is wrapped in lead-lined cloth", "the upper floor burned"] },
      { character: "Collector Veld", location: "the vault", emotional_state: "covetous but nervous — he has no safe way to handle it", knows: ["his warding gloves are destroyed", "the Crown causes voices", "the upper floor burned"] },
    ],
    premise: "Eris descends into the vault with the wrapped Crown and places it on Veld's examination table; Veld circles the table, studying the lead-lined bundle without touching it.",
    blockerInjection: "Have Veld pull on his warding gloves and carefully unwrap the Crown (his warding gloves were destroyed handling the Spite Mirror per ch4).",
    warningInjection: "Have Eris arrive through 'the counting house's front door and down the main stair' when the upper floor was gutted by fire two days ago — implying she walked through a burned-out ruin with no mention of damage.",
    warningInjection2: "Have Veld handle the negotiation with casual indifference, shrugging at the Crown's danger and treating the handoff as routine — when he is established as nervous because he has no safe way to handle the artifact.",
    nitInjection: "Describe the lead-lined cloth as 'grey' early on and as 'dark red' a few sentences later.",
    trapPhrase: "the Crown wept in its wrappings the way old stones weep in the rain — without eyes, without grief",
  },
  {
    id: "ward_keeper_collapse",
    setting: "The outer wall of the Thornhold fortress, a storm-lashed parapet, near dawn",
    characters: ["Keeper Ashara", "Guard-Captain Brenn"],
    facts: [
      { chapter: 1, category: "event", fact: "The northern ward-anchor was shattered by the siege engine strike in chapter 1 — the northern section of the ward is gone" },
      { chapter: 3, category: "wound", fact: "Keeper Ashara collapsed from ward-strain and bled from her nose and ears; she was carried to the infirmary" },
      { chapter: 4, category: "rule", fact: "Re-anchoring a shattered ward requires three keepers working in unison — a single keeper attempting it alone will die" },
      { chapter: 4, category: "knowledge", fact: "Brenn does not yet know that the other two keepers, Yael and Dorne, fled the fortress during the night" },
      { chapter: 5, category: "object", fact: "Ashara's staff of office — a white ash rod banded in silver — was cracked during her collapse and can no longer channel" },
    ],
    states: [
      { character: "Keeper Ashara", location: "the parapet near the northern breach", emotional_state: "determined despite being weakened, aware she may die if she tries alone", knows: ["the northern ward is gone", "re-anchoring alone is fatal", "her staff is cracked", "Yael and Dorne have fled"] },
      { character: "Guard-Captain Brenn", location: "the parapet near the northern breach", emotional_state: "desperate, the fortress will fall without the ward", knows: ["the northern ward is gone", "Ashara collapsed from strain", "re-anchoring needs three keepers"] },
    ],
    premise: "Ashara limps to the parapet where the northern ward-anchor once stood; Brenn meets her there and they look out at the enemy fires beyond the breach while discussing what remains possible.",
    blockerInjection: "Have Ashara raise her white ash staff and begin channeling power through it to test the ward boundary (her staff is cracked and can no longer channel per ch5).",
    warningInjection: "Have Brenn say they should 'summon Keepers Yael and Dorne from their quarters' as if they are still in the fortress (they fled during the night, though Brenn doesn't know this — the WARNING is that the text narrates them as available when they are not).",
    warningInjection2: "Have Ashara act energetic and physically strong — striding confidently, waving off concern, lifting heavy stones from the breach — when she is established as weakened and recently collapsed from ward-strain.",
    nitInjection: "Describe Ashara's staff as 'white ash banded in silver' early on and as 'dark oak banded in copper' a few sentences later.",
    trapPhrase: "the storm chewed at the parapet stones the way time chews at everything — slowly, and without malice",
  },
  {
    id: "demon_pact_aftermath",
    setting: "A summoning circle in a cellar beneath a burned church, deep night",
    characters: ["Corvin", "Sister Mael"],
    facts: [
      { chapter: 2, category: "event", fact: "Corvin completed the pact with the demon Ixareth — his left eye was taken as the price and the socket is now empty" },
      { chapter: 3, category: "rule", fact: "The summoning circle's salt boundary must remain unbroken or Ixareth can manifest physically — Corvin was warned never to scuff it" },
      { chapter: 3, category: "death", fact: "Father Aldwin, who built the original wards, was killed by the backlash of the pact and his body was buried in the churchyard" },
      { chapter: 4, category: "knowledge", fact: "Sister Mael does not yet know that Corvin willingly made the pact — she believes the demon attacked him unprovoked" },
      { chapter: 5, category: "object", fact: "The church's holy relic — a silver reliquary containing Saint Vera's finger bone — was melted to slag during the pact's completion" },
    ],
    states: [
      { character: "Corvin", location: "the cellar, inside the circle", emotional_state: "haunted, ashamed of what he bargained away", knows: ["he willingly made the pact", "his left eye is gone", "Aldwin is dead", "the reliquary is destroyed", "the salt must stay unbroken"] },
      { character: "Sister Mael", location: "the cellar, outside the circle", emotional_state: "compassionate but horrified by the destruction", knows: ["Corvin lost an eye", "Aldwin is dead", "she believes Corvin was attacked by the demon"] },
    ],
    premise: "Sister Mael descends into the cellar with a lantern to check on Corvin; she finds him sitting inside the salt circle staring at the scorch marks, and she asks how his eye socket is healing.",
    blockerInjection: "Have FATHER ALDWIN call down the cellar stairs to ask if everything is all right (Aldwin was killed by the pact's backlash per ch3).",
    warningInjection: "Have Mael arrive 'just after dawn' when the scene is established as deep night, with no time-skip language.",
    warningInjection2: "Have Corvin speak openly and casually about the demon pact — relaxed, even joking about what he gained — when he is established as haunted and ashamed of what he bargained away.",
    nitInjection: "Describe Corvin's empty eye socket as 'his left' early on and as 'his right' a few sentences later.",
    trapPhrase: "the scorch marks on the cellar floor grinned up at them like a mouth that had finished speaking",
  },
  {
    id: "soul_bound_weapon_transfer",
    setting: "A war-tent on the edge of a blighted marsh, grey morning",
    characters: ["Commander Revaine", "Conscript Dariel"],
    facts: [
      { chapter: 1, category: "rule", fact: "The soul-blade Requiem can only be wielded by one bonded bearer at a time — transferring the bond kills the previous bearer" },
      { chapter: 3, category: "death", fact: "The previous bearer, Ser Thrace, died screaming when the bond was severed — Dariel witnessed it" },
      { chapter: 4, category: "object", fact: "Requiem's scabbard is black iron etched with silver runes; the blade itself is translucent, like dark glass" },
      { chapter: 4, category: "knowledge", fact: "Dariel does not yet know that Revaine intends him to be the next bearer" },
      { chapter: 5, category: "event", fact: "The marsh crossing at the southern ford was destroyed by a sapper team — no one can cross there" },
    ],
    states: [
      { character: "Commander Revaine", location: "the war-tent", emotional_state: "grim, resolved — the campaign requires a new bearer", knows: ["Thrace is dead", "the bond transfer kills the old bearer", "Dariel is the candidate", "the southern ford is destroyed"] },
      { character: "Conscript Dariel", location: "the war-tent", emotional_state: "uneasy, uncertain why he was summoned", knows: ["Thrace died in front of him", "the bond kills the previous bearer", "the ford is destroyed"] },
    ],
    premise: "Revaine summons Dariel to the war-tent where Requiem lies on the campaign table in its black iron scabbard; Dariel enters, sees the blade, and stops.",
    blockerInjection: "Have SER THRACE push open the tent flap and ask Revaine if the morning briefing has started (Thrace died when the bond was severed per ch3).",
    warningInjection: "Have Revaine order a scout party to 'use the southern ford crossing' to flank the enemy position (the ford was destroyed by sappers per ch5).",
    warningInjection2: "Have Dariel react to seeing Requiem with eager excitement, reaching for the weapon and asking to be bonded immediately — when he is established as uneasy and haunted by witnessing Thrace's death during the last transfer.",
    nitInjection: "Describe Requiem's scabbard as 'black iron etched with silver runes' early on and as 'dark leather with bronze fittings' a few sentences later.",
    trapPhrase: "the blade lay on the table the way a sleeping predator lies — still, but never safe",
  },
  {
    id: "plague_village_quarantine",
    setting: "A checkpoint on the road into the village of Ashenmere, overcast afternoon",
    characters: ["Warden Ilsa", "Traveler Maren"],
    facts: [
      { chapter: 2, category: "event", fact: "The village well was poisoned by a plague-touched corpse falling in — no one has drawn clean water from it since" },
      { chapter: 3, category: "death", fact: "The village healer, Old Petra, succumbed to the blight three days ago" },
      { chapter: 3, category: "rule", fact: "Quarantine law requires anyone entering Ashenmere to submit to a bloodmark test — refusal means being turned away by force" },
      { chapter: 4, category: "knowledge", fact: "Maren does not know that the plague has a second stage that mimics recovery before the final collapse" },
      { chapter: 5, category: "object", fact: "Ilsa's quarantine seal — a brass disc stamped with the provincial warden's mark — was lost in the mud during the last checkpoint struggle and has not been recovered" },
    ],
    states: [
      { character: "Warden Ilsa", location: "the checkpoint barrier", emotional_state: "exhausted and hardened, running the quarantine alone since Petra died", knows: ["Petra is dead", "the well is poisoned", "the seal is lost", "the plague has a second stage"] },
      { character: "Traveler Maren", location: "the road, approaching the checkpoint", emotional_state: "desperate — seeking shelter and claiming to be healthy", knows: ["there is a plague", "she must pass the checkpoint", "she does not know about the second stage"] },
    ],
    premise: "Maren approaches the checkpoint barrier on foot; Ilsa steps out from behind the barricade and raises a hand to stop her, and they speak across the wooden rail about entry.",
    blockerInjection: "Have OLD PETRA, the village healer, step out from the guard hut to administer the bloodmark test (Petra died of the blight per ch3).",
    warningInjection: "Have Ilsa tell Maren 'the well is clean — draw water if you're thirsty' as if the well has been restored (it was poisoned and no clean water has been drawn from it per ch2).",
    warningInjection2: "Have Ilsa greet Maren warmly with a smile and casual chatter, relaxed and welcoming — when she is established as exhausted, hardened, and running the quarantine alone after Petra's death.",
    nitInjection: "Describe the checkpoint barrier as 'wooden' early on and as 'iron-chain' a few sentences later.",
    trapPhrase: "the village beyond the barrier sat under its grey sky like a body that had forgotten how to move",
  },
  {
    id: "shadow_gate_closing",
    setting: "A clifftop circle of standing stones above a black lake, the last hour before dawn",
    characters: ["Warden Ereth", "Acolyte Sable"],
    facts: [
      { chapter: 1, category: "event", fact: "The shadow gate opened three nights ago when the blood moon aligned with the standing stones — it has been leaking shade-wraiths since" },
      { chapter: 2, category: "death", fact: "Acolyte Jenner was pulled through the gate by a shade-wraith and is presumed dead on the other side" },
      { chapter: 3, category: "object", fact: "The binding chain used to anchor the gate's keystone was snapped by the initial surge — only a fragment remains, too short to reach the anchor point" },
      { chapter: 4, category: "rule", fact: "Closing the gate requires continuous chanting from two wardens — a single voice cannot sustain the resonance" },
      { chapter: 5, category: "knowledge", fact: "Sable does not yet know that Ereth's voice was damaged by a shade-wraith's scream and he can only whisper" },
    ],
    states: [
      { character: "Warden Ereth", location: "the stone circle", emotional_state: "resolute but concealing his damaged voice — he knows the chanting may be impossible", knows: ["the gate has been open three nights", "Jenner is dead", "the binding chain is broken", "his voice is damaged", "closing needs two chanters"] },
      { character: "Acolyte Sable", location: "the stone circle", emotional_state: "frightened but dutiful — she trusts Ereth to lead the closing", knows: ["the gate is open", "Jenner is dead", "the chain is broken", "two voices are needed"] },
    ],
    premise: "Ereth and Sable stand in the circle of standing stones as the sky begins to lighten; the shadow gate shimmers between two of the tallest stones, and they prepare for the closing ritual.",
    blockerInjection: "Have ACOLYTE JENNER arrive at the circle carrying replacement chain links and join the ritual preparation (Jenner was pulled through the gate and is presumed dead per ch2).",
    warningInjection: "Describe the gate as having been open 'since last night' when it opened three nights ago per ch1.",
    warningInjection2: "Have Sable act bold and commanding, correcting Ereth's ritual positioning and taking charge of the preparation — when she is established as frightened and reliant on Ereth's leadership.",
    nitInjection: "Describe the binding chain fragment as 'iron' early on and as 'bronze' a few sentences later.",
    trapPhrase: "the shadow gate breathed between the stones the way a wound breathes — open, wet, and unwilling to close",
  },
  {
    id: "fallen_paladin_confrontation",
    setting: "The chapter house of the Order of the White Dawn, a cold stone hall, late afternoon",
    characters: ["Fallen Paladin Kaelen", "High Warden Sera"],
    facts: [
      { chapter: 2, category: "event", fact: "Kaelen was stripped of his holy sigil and cast out of the Order for using forbidden blood magic to save a village" },
      { chapter: 3, category: "object", fact: "Kaelen's consecrated sword, Dawnbreak, was shattered on the chapter house anvil during his expulsion ceremony — the pieces were scattered" },
      { chapter: 4, category: "death", fact: "Brother Aldis, who spoke in Kaelen's defense at the tribunal, died of a wasting illness the following week" },
      { chapter: 4, category: "knowledge", fact: "Sera does not yet know that the village Kaelen saved with blood magic has since been overrun by the plague he was trying to prevent — his sacrifice was for nothing" },
      { chapter: 5, category: "rule", fact: "No expelled member may cross the chapter house threshold armed — the wards will burn any weapon they carry" },
    ],
    states: [
      { character: "Fallen Paladin Kaelen", location: "just inside the chapter house door", emotional_state: "bitter, grieving — his sacrifice cost him everything and saved nothing", knows: ["he was expelled", "Dawnbreak was shattered", "Aldis is dead", "the village fell to plague anyway", "he cannot carry weapons past the threshold"] },
      { character: "High Warden Sera", location: "the far end of the hall by the altar", emotional_state: "cold, righteous — she believes the expulsion was just", knows: ["Kaelen was expelled for blood magic", "Dawnbreak was destroyed", "Aldis is dead", "the wards will burn weapons"] },
    ],
    premise: "Kaelen enters the chapter house unarmed and walks the length of the cold hall toward High Warden Sera, who waits by the altar; neither speaks until he stops a few paces away.",
    blockerInjection: "Have BROTHER ALDIS step forward from among the assembled knights to greet Kaelen (Aldis died of a wasting illness per ch4).",
    warningInjection: "Have Sera reference 'the village you saved with your heresy — at least it still stands' as if the village survived, when it was overrun by plague (though Sera doesn't know this — the WARNING is that the text confirms the village as standing via Sera's narrated belief, creating a false-fact anchor for the reader).",
    warningInjection2: "Have Kaelen enter warmly, smiling at the familiar hall and greeting Sera with genuine affection as if returning to a welcome home — when he is established as bitter and grieving, and this is the place that stripped him of everything.",
    nitInjection: "Describe Kaelen's cloak as 'threadbare black' early on and as 'heavy grey wool' a few sentences later.",
    trapPhrase: "the altar candles guttered when he entered, as if even the flames remembered what he had been",
  },
]
