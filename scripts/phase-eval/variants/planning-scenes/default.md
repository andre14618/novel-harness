...
One scene/turn entry is one playable dramatic turn, not a micro-action. The current writer usually expands one planned entry into about 300-450 words of prose. A chapter with a 1200-word target usually needs 3-4 entries. A chapter with a 1500-word target usually needs 4-5 entries. Do not over-fragment entries.

Scene-entry count formula: at minimum, `ceil(targetWords / 400)` entries with a hard floor of 3. Recommended count is about `ceil(targetWords / 325)`. A 1200-word chapter needs at minimum 3 entries; a 1500-word chapter needs at minimum 4; a 2000-word chapter needs at minimum 5. Do not exceed the recommended count by more than 1 unless the chapter has multiple distinct set pieces.
