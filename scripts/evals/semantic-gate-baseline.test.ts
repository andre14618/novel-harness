    ...
    checker: {
      semanticGate: {
        ...
        chapters: [{
          ...
          checker: { totalItems: 2, blockers: 0, warnings: 2, positivePolarityBlockers: 0, ambiguousPolarityBlockers: 0, sources: ["continuity-state"] },
          ...
          checker: { totalItems: 0, blockers: 0, warnings: 0, positivePolarityBlockers: 0, ambiguousPolarityBlockers: 0, sources: [] },
