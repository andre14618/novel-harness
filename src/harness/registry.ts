...
export const COMPONENTS: Component[] = [
  ...
  // ── Concept agent prompts ──────────────────────────────────────────────
  {
    ...
    type: "prompt", storage: "file", path: "src/agents/world-builder/prompt.md",
    measuredBy: ["context-relevance", "context-completeness"],
    category: "agent-prompt",
  },
  {
    ...
    type: "prompt", storage: "file", path: "src/agents/character-agent/prompt.md",
  ...
  },
  {
    ...
    type: "prompt", storage: "file", path: "src/agents/plotter/prompt.md",
