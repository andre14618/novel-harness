  ...
  if (path === "/api/novel/config" && req.method === "GET") {
    try {
      ...
      const agentGroups: Record<string, { label: string; description: string; agents: string[] }> = {
        ...
        planners: { label: "Planners", description: "World, characters, plot, chapter outlines", agents: ["world-builder", "character-agent", "plotter", "planning-plotter", "planning-scenes", "planning-state-mapper", "planning-state-repair"] },
