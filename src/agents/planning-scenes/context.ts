...
- Outcome/consequence are the entry's terminal landing, not mid-entry setup. They must match the action or change promised by the description; do not let the description say the characters probe a perimeter while the outcome says they wait.
- Consequence must add external downstream pressure that differs from both outcome and turningPoint. Do not duplicate the same sentence across outcome, consequence, and turningPoint.
